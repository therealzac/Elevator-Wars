...
var challenges = [
     ...
     {options: {floorCount: 5,
                ...
                condition: timeLimit(23, 60)},
     {options: {floorCount: 8,
                elevatorCount: 2,
                spawnRate: 0.6},
                condition: timeLimit(28, 60)},

     {options: {floorCount: 6,
                elevatorCount: 4,
                spawnRate: 1.7},
                condition: timeLimit(100, 68)},

     {options: {floorCount: 4,
                elevatorCount: 2,
                spawnRate: 0.8},
                condition: moveLimit(40, 60)},

     {options: {floorCount: 3,
                elevatorCount: 3,
                spawnRate: 3.0},
                condition: moveLimit(100, 63)},

     {options: {floorCount: 6,
                elevatorCount: 2,
                spawnRate: 0.4,
                elevatorCapacities: [5]},
                condition: waitLimit(50, 21)},
